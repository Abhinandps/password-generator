...
function InputField({ type = 'text', label, secure }: any) {
    return (
        <div style={{ textAlign: 'left', width: '350px', margin: '10px 20px' }}>
            ...
            <div style={{ backgroundColor: 'rgb(90 90 90 / 79%)', boxShadow: '0px 0px 2px', borderRadius: '8px', textAlign: 'left', position: 'relative' }}>
                <input type={type} readOnly style={{ outline: 'none', width: '100%', height: '100%', background: 'transparent', border: 'none', padding: '15px 20px' }} />
